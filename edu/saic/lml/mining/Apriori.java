...
public class Apriori {
	...
	public static void main(String[] args) {
		String fname = "fulong.over18.all.txt";
		String mapname = "mapping.txt";
	...
	public void doApriori() {
		...
		Object[] objs = apriori(dataSet, 0.5);
		...
		//}
		outputL(L);
		ArrayList<Rule> rules = generateRules(L, suppData, 0.8);
	...
	private class Rule {
		...
		public String toString(HashMap<String, String> mapping) {
			...
			result = "conf:"+conf+","+result.substring(0, result.length()-1)+"]";
			return result;
		}
	}
