...
public class AprioriOld {
	
	public static void main(String[] args) {
		String fname = "fulong.over18.txt.out";
		AprioriOld apriori = new AprioriOld();
		ArrayList<ArrayList<String>> dataSet = apriori.loadDataSet(fname);
		...
		//}
		apriori.outputL(L);
		ArrayList<Rule> rules = apriori.generateRules(L, suppData, 0.8);
	...
	private class Rule {
		...
		public String toString() {
			return "Conf:"+conf+", "+freqSet+"-->"+conseq;
		}
	}
